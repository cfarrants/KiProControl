...
class Overview(tk.Frame):
    ...
    def btnRecord_click(self):
        change = self.unit_status[1]
        change.config(text="Hello")
...
class Settings(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #self.iplist = [] #Defile a list for storing IP address in
        ...
        for i in range(num_units):
            ...
            e.insert(0, self.iplist[i]) #Pull ip address from the list
    ...
    #Read IP addresses stored in the file into a list
    def populateIP(self):
    ...
    def setIP(self, index, data):
        ...
        self.iplist[index] = text #Update that IP address in the IP list
