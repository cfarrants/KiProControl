...
"""
    ...
    def sendTransportCommandByDescription(self, term):
        ...
        """
        # print("Runnning: sendTransportCommandByDescription")
    ...
    def test(self):
        ...
        data = self.getParameter("eParamID_CustomClipName")

        print(data)

        # self.setParameter("eParamID_EncodeType_Low_FR", '0')
        # print(data)
        # write_params = self.getWriteableParameters()
